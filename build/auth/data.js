...
exports.isDuplicateUser = exports.getUser = void 0;
function getUser(db, _a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            ...
            if (email)
                if (phone) {
                    dbPromise = db.query("SELECT * FROM user WHERE (email = ? AND phone = ?)", [email, phone]);
                }
                else {
...
function isDuplicateUser(db, _a) {
    var email = _a.email, phone = _a.phone;
    return __awaiter(this, void 0, void 0, function () {
        var dbPromise;
        return __generator(this, function (_b) {
            dbPromise = null;
            return [2 /*return*/, db.query("SELECT email, phone from user WHERE (email = ? OR phone = ?)", [email, phone])
